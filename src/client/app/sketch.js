...
function draw() {
  background(127);
  if(img != undefined) image(img,20,20);
  // Draw a circle
  strokeWeight(2);
  stroke(r, g, b);
  fill(r, g, b, 127);
  //image(cowVideo,10,10);
  if(newVideo) image(newVideo, w/2,10);
  ellipse(w/2, h/2, h/4, h/4);
  var fps = frameRate();
